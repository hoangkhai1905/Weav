...
This project is indexed by GitNexus as **Weav** (2451 symbols, 3764 relationships, 62 execution flows).
...
- If the managed runner reports `helper_unknown_error`, distinguish environment/setup failure from source failure. Verify the resolved workspace path and use a working junction/worktree only when it resolves to this repository; do not"��y��y�fi{�u���] source code based only on runner setup errors.
