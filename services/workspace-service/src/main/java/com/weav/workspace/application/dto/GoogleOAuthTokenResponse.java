...
/** Validated Google token exchange result; token values never appear in toString(). */
public record GoogleOAuthTokenResponse(
    ...
    public GoogleOAuthTokenResponse {
        accessToken = requireToken(accessToken);
        refreshToken = requireToken(refreshToken);
    ...
    public String toString() {
        return "GoogleOAuthTokenResponse[accessToken=<redacted>, refreshToken=<redacted>, tokenType="
