...
public class WorkflowExecutionJpaEntity {
    ...
    public WorkflowExecutionJpaEntity(UUID workflowId, UUID workflowVersionId, ExecutionTriggerType triggerType, UUID triggerId, UUID triggeredBy, JsonNode input) {
