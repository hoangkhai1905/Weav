...
public class NodeExecutionAttempt {
    ...
    public NodeExecutionAttempt(UUID id, UUID nodeExecutionId, Integer attemptNumber, AttemptStatus status, Map<String,Object> input,
        ...
        this.input=JsonValues.freezeMap(input); this.output=JsonValues.freezeMap(output); this.error=JsonValues.freezeMap(error);
    ...
    public void succeed(Map<String,Object> output, Instant at) {
    ...
    public void fail(Map<String,Object> error, Instant at) {
