...
public class ExecutionLogJpaEntity {
    ...
    protected ExecutionLogJpaEntity() {
    }

    public ExecutionLogJpaEntity(UUID executionId, UUID nodeExecutionId, UUID attemptId, LogLevel level, String eventType, String message, JsonNode metadata) {
